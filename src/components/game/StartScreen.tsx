...
SURVIVAL</h1>
      ...
      <Button onClick={handleStart} size="lg" className="text-lg sm:text-xl px-8 sm:px-12 py-6 sm:py-8 bg-primary hover:bg-primary/80 animate-pulse-glow flex items-center gap-2">
        {isMobile && <Maximize2 className="w-5 h-5" />}
        게임 시작
      </Button>

      {isMobile && <p className="mt-4 text-xs text-muted-foreground flex items-center gap-2">
      ...
      <div className="mt-6 sm:mt-12 text-center text-muted-foreground">
        ...
        {isMobile ? <div className="flex flex-col items-center gap-2">
